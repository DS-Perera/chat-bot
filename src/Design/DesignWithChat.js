...
export default function DesignWithChat() {
  ...
  useEffect(() => {
    var offsetHeight = document.getElementById("chatArea").offsetHeight;
    console.log(offsetHeight);
  }, [chat]);
  useEffect(() => {
    // const userId = ;
    setUserId(Math.round(Math.random() * 100000));
